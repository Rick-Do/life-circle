...
export const ENTER_ANIMATION = [
    {
        ...
        children: [
            ...
            {name:"向右弹入", value: "bounceInRight"},
            {name:"向左弹入", value: "bounceInLeft"},
    ...
    },
    {
        ...
        children: [
            ...
            {name:"向右浮入", value: "fadeInRight"},
            {name:"向右长距浮入", value: "fadeInRightBig"},
            {name:"向左浮入", value: "fadeInLeft"},
            {name:"向左长距浮入", value: "fadeInLeftBig"},
            {name:"向上浮入", value: "fadeInUp"},
            {name:"向上长距浮入", value: "fadeInUpBig"},
            {name:"从左上浮入", value: "fadeInTopLeft"},
            {name:"从右上浮入", value: "fadeInTopRight"},
            {name:"从左下浮入", value: "fadeInDownLeft"},
            {name:"从右下下浮入", value: "fadeInDownRight"},
        ]
    },
    {
        type: "rotate",
    ...
    },
    {
        ...
        name: "翻转",
        children: [
            {name: "X轴反转进入", value: "flipInX"},
            {name: "Y轴反转进入", value: "flipInY"},
        ]
    },
    {
        type: "back",
